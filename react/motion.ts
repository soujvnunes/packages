...
// True when a node is an `<AnimatePresence>` with no rendered children, meaning every child is falsy (null/undefined/false/''). Lets a layout skip wrapper markup that would otherwise reserve space around an empty presence.
